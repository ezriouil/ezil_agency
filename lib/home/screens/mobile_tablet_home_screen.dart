...
class MobileTabletHomeScreen extends Responsive {
  const MobileTabletHomeScreen({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding:
              const EdgeInsets.all(CustomSizes.SPACE_BETWEEN_SECTIONS),
              child: Column(
                    ...
                    children: [
                      Expanded(
                          child: CustomServiceItem(
                              ...
                              header: "Web Design",
                              textSize: Theme.of(context).textTheme.bodyMedium,
                              title:
                              "Mobile Application Mastery: Crafting Innovative Solutions")),
                      const SizedBox(width: CustomSizes.SPACE_BETWEEN_SECTIONS / 2),
                      Expanded(
                          child: CustomServiceItem(
            ...
            Text("Notre Projects Digital",
                style: Theme.of(context)
                    .textTheme
                    .headlineLarge
                    ?.copyWith(fontSize: 30,fontFamily: "Cal")),
