...
class CustomAppBarTheme {
  ...
  static AppBarTheme lightAppBarTheme = const AppBarTheme(
        ...
        iconTheme: IconThemeData(color: CustomColors.BLACK, size: 20),
        actionsIconTheme: IconThemeData(color: CustomColors.BLACK, size: 20),
  ...
  static AppBarTheme darkAppBarTheme = const AppBarTheme(
      ...
      backgroundColor: CustomColors.TRANSPARENT,
      surfaceTintColor: CustomColors.TRANSPARENT,
      iconTheme: IconThemeData(color: CustomColors.WHITE, size: 20),
      actionsIconTheme: IconThemeData(color: CustomColors.WHITE, size: 20),
      systemOverlayStyle: SystemUiOverlayStyle(
